A simple mod to make the Travelling Merchant have a chance to sell the Katana. The idea is to use this as a base for future mods adding items to vendors.
